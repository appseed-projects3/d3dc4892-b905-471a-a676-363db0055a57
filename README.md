...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-11 09:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d3dc4892-b905-471a-a676-363db0055a57.git
$ cd d3dc4892-b905-471a-a676-363db0055a57
```
